            ...
            <div className="container">
                ...
                <div className="flex gap-4 justify-between">
                    <div className='flex items-center w-1/3 gap-4'>
                        ...
                        <div>
                            <h4 className='text-[#333537] text-[24px] font-semibold mb-[6px]'>Working Hours</h4>
                            <p className='fsSm text-[#989ea6] flex items-center gap-[6px] mb-2 last-of-type:mb-0'><span className='uppercase text-[#989ea6] font-semibold'>MON - SAT:</span> 7 am – 8 pm</p>
                            <p className='fsSm text-[#989ea6] flex items-center gap-[6px] mb-2 last-of-type:mb-0'><span className='uppercase text-[#989ea6] font-semibold'>SUN:</span>  9.00 am – 5.00 pm</p>
                        </div>
                    </div>
                    <div className='flex items-center w-1/3 gap-4'>
                        <div className='text-[50px] w-[52px] h-[52px] text-[#f0b913] opacity-90'>
                        ...
                        <div>
                            <h4 className='text-[#333537] text-[24px] font-semibold mb-[6px]'>Call Us Toll Free</h4>
                            <p className='fsSm text-[#989ea6] flex items-center gap-[6px] mb-2 last-of-type:mb-0'><a href='tel:+61 476 909 090' className='text-[#989ea6] hover:text-[#f0b913]'>+61 476 909 090 </a>  (Delivery Department) </p>
                        </div>
                    </div>
                    <div className='flex items-center w-1/3 gap-4'>
                        <div className='text-[50px] w-[52px] h-[52px] text-[#f0b913] opacity-90'>
                        ...
                        <div>
                            <h4 className='text-[#333537] text-[24px] font-semibold mb-[6px]'>Main Office Address</h4>
                            <p className='fsSm text-[#989ea6] flex flex-col gap-[2px] mb-2 last-of-type:mb-0'><span className='uppercase text-[#989ea6] font-semibold block'>EMPIRE STATE BUILDING</span> 1551 State Route 55, Campbelfield VIC 3061</p>
                        </div>
                    </div>
