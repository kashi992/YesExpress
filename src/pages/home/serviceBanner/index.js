    ...
    return (
        <div className='py100'>
            <div className="container">
                ...
                <TitleBox title1Css="secondaryClr animate__animated animate__backInLeft" title2Css="primaryClr" borderWrap="justify-center animate__animated animate__backInDown" className="text-center" borderCss="primaryClrBg" title1="Reliable Sea Freight Services" title2='to and from Australia and Pakistan' detail="From small packages to large cargoes, YES EXPRESS SERVICES offers comprehensive shipping solutions by sea and air. Our expertly coordinated logistics ensure your shipments move smoothly between Australia and Pakistan, with full regulatory compliance and real-time tracking for peace of mind." detailCss="animate__animated animate__backInRight" />
