...
const FindSolution = () => {
  return (
    <div className='bannerBg py100' style={{height: 'auto', backgroundImage: `url(${bgImg})`}}>
      ...
      <Button text="Get a Free quote" className="bg-[#333537] text-white hover:text-[#333537] hover:bg-white uppercase"/>
      <Button text="contact us now" className="bg-[#333537] text-white hover:text-[#333537] hover:bg-white uppercase"/>
      </div>
      </div>
    </div>
  )
